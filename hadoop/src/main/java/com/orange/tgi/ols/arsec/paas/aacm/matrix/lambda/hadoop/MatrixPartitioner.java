...
/** {@inheritDoc} */
public class MatrixPartitioner<T extends Number> extends
		Partitioner<BlockKey, Matrix<T>> implements Configurable {
	...
	public int getPartition(BlockKey key, Matrix<T> value, int numPartitions) {
		int nb = Math.floorDiv(conf.getInt(MatrixParameter.nBlocks, 0),
				numPartitions);
