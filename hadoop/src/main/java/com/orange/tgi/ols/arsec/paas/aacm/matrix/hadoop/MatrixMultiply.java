...
public class MatrixMultiply<T extends Number, U extends Number,
  ...
  public int run(String[] args) throws Exception {
    ...
    String xType = conf.get(MatrixParameter.xType, null),
        yType = conf.get(MatrixParameter.yType, null);
    if ((xType == null) || (yType == null))
      throw new InvalidJobConfException("Le parametre " + MatrixParameter.xType
          + " ou " + MatrixParameter.yType + " n'a pas ete renseigne.");
    @SuppressWarnings("unchecked")
    DataOperator<T, U,
        R> dataOperator = (DataOperator<T, U, R>) DataOperator.builder(
            Matrix.DataTypeDescriptionID.get(xType),
