...
public class MatrixRecordReader extends RecordReader<BlockKey, NullWritable> {
	...
	public void initialize(InputSplit inputSplit,
		...
		mb = (taskAttemptContext.getNumReduceTasks() == 0) ? nb : conf.getInt(
				MatrixParameter.mBlocks, 0);
		mb1 = Math.floorDiv(mb, mtasks);
		nb2 = (matrixSplit.getiTask() == ntasks - 1) ? (nb - (matrixSplit
				.getiTask() * nb1)) : nb1;
		mb2 = (matrixSplit.getjTask() == mtasks - 1) ? (mb - (matrixSplit
				.getjTask() * mb1)) : mb1;
		i = 0;
