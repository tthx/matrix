...
@ContextConfiguration(locations = { "classpath:META-INF/spring/miniClusterApplicationContext.xml" })
public class MatrixTest {
	...
	@Autowired
	private JobRunner matrixMultiplyJobRunner;

	/*
	 * @Before public void getContext() { ApplicationContext ctx = new
	 * ClassPathXmlApplicationContext(
	 * "classpath:META-INF/spring/applicationContext.xml"); hadoopConfiguration
	 * = (Job) ctx .getBean("matrixMultiplyJobConfiguration"); }
	 */
	@Test
	public void multiplyByte() throws NumberFormatException, IOException,
			MatrixBoundMultiplicationException {
		Matrix<Byte> x = (Matrix<Byte>) Matrix.builder(5, 10,
				Matrix.DataType.Byte, true, null, true, null, null);
		Matrix<Byte> y = (Matrix<Byte>) Matrix.builder(10, 3,
				Matrix.DataType.Byte, true, null, true, null, null);
		Matrix<Integer> z;
		DataOperator<Byte, Byte, Integer> dataOperator = (DataOperator<Byte, Byte, Integer>) DataOperator
	...
	public void multiplyShort() throws NumberFormatException, IOException,
		...
		Matrix<Short> y = (Matrix<Short>) Matrix.builder(10, 3,
				Matrix.DataType.Short, true, null, true, null, null);
		Matrix<Integer> z;
		DataOperator<Short, Short, Integer> dataOperator = (DataOperator<Short, Short, Integer>) DataOperator
				.builder(x.getDataType(), y.getDataType());
		z = Matrix.multiply(x, y, dataOperator.getSumR(),
				dataOperator.getMultiply());
		System.out.printf("x:[\n%s\n]\n", x.toString());
	...
	public void multiplyByteShort() throws NumberFormatException, IOException,
		...
		Matrix<Short> y = (Matrix<Short>) Matrix.builder(10, 3,
				Matrix.DataType.Short, true, null, true, null, null);
		Matrix<Integer> z;
		DataOperator<Byte, Short, Integer> dataOperator = (DataOperator<Byte, Short, Integer>) DataOperator
				.builder(x.getDataType(), y.getDataType());
		z = Matrix.multiply(x, y, dataOperator.getSumR(),
				dataOperator.getMultiply());
		System.out.printf("x:[\n%s\n]\n", x.toString());
	...
	public void multiplyInteger() throws NumberFormatException, IOException,
		...
		Matrix<Integer> y = (Matrix<Integer>) Matrix.builder(10, 3,
				Matrix.DataType.Integer, true, null, true, null, null);
		Matrix<Integer> z;
		DataOperator<Integer, Integer, Integer> dataOperator = (DataOperator<Integer, Integer, Integer>) DataOperator
				.builder(x.getDataType(), y.getDataType());
		z = Matrix.multiply(x, y, dataOperator.getSumR(),
				dataOperator.getMultiply());
		System.out.printf("x:[\n%s\n]\n", x.toString());
	...
	@Test
	public void multiplyIntegerDouble() throws NumberFormatException,
		...
		Matrix<Double> z;
		DataOperator<Integer, Double, Double> dataOperator = (DataOperator<Integer, Double, Double>) DataOperator
				.builder(x.getDataType(), y.getDataType());
		z = Matrix.multiply(x, y, dataOperator.getSumR(),
				dataOperator.getMultiply());
		System.out.printf("x:[\n%s\n]\n", x.toString());
	...
	@Test
	public void multiplyFloatDouble() throws NumberFormatException,
			IOException, MatrixBoundMultiplicationException {
		...
		Matrix<Double> z;
		DataOperator<Float, Double, Double> dataOperator = (DataOperator<Float, Double, Double>) DataOperator
				.builder(x.getDataType(), y.getDataType());
		z = Matrix.multiply(x, y, dataOperator.getSumR(),
				dataOperator.getMultiply());
		System.out.printf("x:[\n%s\n]\n", x.toString());
	...
	public void multiplyBigInteger() throws NumberFormatException, IOException,
		...
		Matrix<BigInteger> y = (Matrix<BigInteger>) Matrix.builder(10, 3,
				Matrix.DataType.BigInteger, true, null, true, null, null);
		Matrix<BigInteger> z;
		DataOperator<BigInteger, BigInteger, BigInteger> dataOperator = (DataOperator<BigInteger, BigInteger, BigInteger>) DataOperator
				.builder(x.getDataType(), y.getDataType());
		z = Matrix.multiply(x, y, dataOperator.getSumR(),
				dataOperator.getMultiply());
		System.out.printf("x:[\n%s\n]\n", x.toString());
	...
	public void multiplyBigDecimalBigInteger() throws NumberFormatException,
		...
		Matrix<BigDecimal> z;
		DataOperator<BigDecimal, BigInteger, BigDecimal> dataOperator = (DataOperator<BigDecimal, BigInteger, BigDecimal>) DataOperator
				.builder(x.getDataType(), y.getDataType());
		z = Matrix.multiply(x, y, dataOperator.getSumR(),
				dataOperator.getMultiply());
		System.out.printf("x:[\n%s\n]\n", x.toString());
	...
	public void multiplyBigIntegerBigDecimal() throws NumberFormatException,
		...
		Matrix<BigDecimal> y = (Matrix<BigDecimal>) Matrix.builder(10, 3,
				Matrix.DataType.BigDecimal, true, "1", true, null, null);
		Matrix<BigDecimal> z;
		DataOperator<BigInteger, BigDecimal, BigDecimal> dataOperator = (DataOperator<BigInteger, BigDecimal, BigDecimal>) DataOperator
				.builder(x.getDataType(), y.getDataType());
		z = Matrix.multiply(x, y, dataOperator.getSumR(),
				dataOperator.getMultiply());
		System.out.printf("x:[\n%s\n]\n", x.toString());
	...
	public void multiplyBigIntegerDouble() throws NumberFormatException,
		...
		Matrix<BigDecimal> z;
		DataOperator<BigInteger, Double, BigDecimal> dataOperator = (DataOperator<BigInteger, Double, BigDecimal>) DataOperator
				.builder(x.getDataType(), y.getDataType());
		z = Matrix.multiply(x, y, dataOperator.getSumR(),
				dataOperator.getMultiply());
		System.out.printf("x:[\n%s\n]\n", x.toString());
	...
	@Test
	public void sumBigInteger() throws NumberFormatException, IOException,
			MatrixBoundAdditionException {
		Matrix<BigInteger> x = (Matrix<BigInteger>) Matrix.builder(5, 10,
				Matrix.DataType.BigInteger, true, "1", true, null, null);
	...
	@Test
	public void addBigInteger() throws NumberFormatException, IOException,
			MatrixBoundAdditionException {
		Matrix<BigInteger> x = (Matrix<BigInteger>) Matrix.builder(5, 10,
				Matrix.DataType.BigInteger, true, "1", true, null, null);
		Matrix<BigInteger> y = (Matrix<BigInteger>) Matrix.builder(5, 10,
	...
	@Test
	public void bigDecimalCopyIO() throws NumberFormatException, IOException,
			MatrixBoundCopyException, MatrixBoundReadException,
	...
	@Test
	public void multiplyBigIntegerBlocksPartition()
		...
		Matrix<BigInteger> x = (Matrix<BigInteger>) Matrix.builder(
				...
				conf.getInt(MatrixParameter.xHeight, 0),
				Matrix.DataType.BigInteger, true, null, true, conf, xPath);
		Matrix<BigInteger> y = (Matrix<BigInteger>) Matrix.builder(
				conf.getInt(MatrixParameter.yWidth, 0),
				conf.getInt(MatrixParameter.yHeight, 0),
				Matrix.DataType.BigInteger, true, null, true, conf, yPath);
		Matrix<BigInteger> z1, z2;
		DataOperator<BigInteger, BigInteger, BigInteger> dataOperator = (DataOperator<BigInteger, BigInteger, BigInteger>) DataOperator
				.builder(x.getDataType(), y.getDataType());
		Matrix.multiply(rPath, xPath, yPath,
				...
				conf.getInt(MatrixParameter.mTasks, 0), conf,
				dataOperator.getSumR(), dataOperator.getMultiply());
	...
	@Test
	public void multiplyBigDecimalBlocksPartition()
			throws NumberFormatException, IOException,
			MatrixBoundMultiplicationException, MatrixBoundReadException,
			MatrixBoundWriteException {
		Configuration conf = matrixMultiplyJobConfiguration.getConfiguration();
